  ...
  return (
    <div className="res-card" style={{ backgroundColor: "#f0f0f0" }}>
      <img
        ...
        //   cloudinaryImageId
        // }
        src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQl6HgRVScYa5FcYAoLCdWgngYMZmglM1z7Aw&s"
      />
      <h3>{name}</h3>
      <h4>{cuisines.join(", ")}</h4>
...
/*Not using keys(not acceptable in react) hence use index as key i.e map second parameter
    or use any unique id from the data as key 
    >>>>>>>>>>>>>Using index as key<<<<<<<<<<<<<<
